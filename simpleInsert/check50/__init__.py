...
class Simple_Insert(Checks):
    ...
    def test_pass_same_low(self):
        """Adds 0.0 to Array  Yields: -3.50 -3.50 5.60 7.00 8.25 9.67 18.30 """
        self.spawn("./simpleInsert").stdin("-3.5").stdout("-3.50 -3.50 5.60 7.00 8.25 9.67 18.30").exit(0)
        
    @check("compiles")
    def test_pass_zero(self):
        """Adds 0.0 to Array  Yields: -3.50 0.00 5.60 7.00 8.25 9.67 18.30 """
        self.spawn("./simpleInsert").stdin("0.0").stdout("-3.50 0.00 5.60 7.00 8.25 9.67 18.30").exit(0)
